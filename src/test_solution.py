...
def test_delete_member(client):
 ...
 @pytest.mark.it("Method DELETE /member/4 should return dictionary with 'done' key")
...
@pytest.mark.it("After deleting the member 4 we called GET /members and it should return a list with 4 members")
